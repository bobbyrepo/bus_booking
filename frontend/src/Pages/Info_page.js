...
const Info_page = () => {
  ...
  const [userDetails, setUserDetails] = useState({
    BusID: busData.busLocation.busID,
    Name: "",
    Gender: "",
    Age: 0,
    Email: "",
    MobileNo: "",
    FromDate: fromTo.INIT_STATE.FromDate.format("yyyy-MM-DD"),
    Seats: busData.busLocation.selectedSeat,
    Price: busData.busLocation.filterPrice,
  });
